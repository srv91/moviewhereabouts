...
for movie in Movie.objects.all():
    ...
    try:
        ...
        print found_genre
        m = models.Movie(id = movie.id, imdb_id = movie.imdb_id, tmdb_id = movie.tmdb_id, title = movie.title, movie_synopsis = movie.synopsis, critics_score = movie.critics_score, release = movie.release, votes = 10, img = movie.img, category = 'latest', genre = found_genre)
        m.save()
        print "genre updated!"
